...
namespace Szn.Editor.Menu
{
    ...
    {
        [MenuItem("Tools/Git/Open GitBase Here %g")]
        static void OpenGitBase()
        {
            ...
            {
                ProcessCommand(@"/Applications/Utilities/Terminal.app/Contents/MacOS/Terminal",
                    "cd " + Application.dataPath.Replace("/Assets", "/"));
            }
